package com.example.boilerplateapplication.common.extensions
 ...
 */
(private val minimumInterval: Long) : TextWatcher {
    private var lastSearch: Long? = null
    private val timer = Timer()
    private val tasks = arrayListOf<TimerTask>()

    open fun debouncedBeforeTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
    open fun debouncedOnTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
    open fun debouncedAfterTextChanged(p0: Editable?) {}
