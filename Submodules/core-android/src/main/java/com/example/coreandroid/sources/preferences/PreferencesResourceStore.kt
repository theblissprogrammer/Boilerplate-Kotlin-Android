...
class PreferencesResourceStore(val context: Context?): PreferencesStore {
    ...
    override val baseUserREST: String
        get() = context?.getString(R.string.base_user_rest) ?: ""

    override val baseProREST: String
        get() = context?.getString(R.string.base_pro_rest) ?: ""
