package com.example.appstores.sources

import android.app.Application
import com.example.appstores.sources.dependencies.Dependency
import com.example.appstores.sources.dependencies.DependencyInjector
...
class AppStore: AppCore(), CoreType {
    ...
    override fun configure(application: Application,
                           dependencies: com.example.coreandroid.sources.dependencies.Dependency) {
